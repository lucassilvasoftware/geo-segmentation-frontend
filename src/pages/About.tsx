      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-muted-foreground">
            Análise inteligente de imagens de sensoriamento remoto com resolução de 30cm
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-border/50 bg-surface-dark/50 backdrop-blur">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <p>
                Este sistema utiliza técnicas avançadas de visão computacional e aprendizado profundo 
                para realizar a segmentação semântica automática de imagens aéreas de alta resolução (30cm).
              </p>
              <p>
                A aplicação foi desenvolvida especificamente para processar imagens no formato GeoTIFF, 
                amplamente utilizado em sensoriamento remoto e sistemas de informação geográfica (SIG).
              </p>
            </CardContent>
          </Card>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Backend otimizado com Lovable Cloud para processar imagens de grande porte com eficiência
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Processamento nativo de arquivos .tif e .tiff com metadados geoespaciais preservados
                  </p>
                </div>

                <div className="space-y-2">
                  <h3 className="font-semibold text-foreground">8 Classes de Segmentação</h3>
                  <p className="text-sm text-muted-foreground">
                    Identificação automática de diferentes tipos de cobertura do solo e uso da terra
                  </p>
                </div>

                <div className="space-y-2">
                  <h3 className="font-semibold text-foreground">Métricas de Precisão</h3>
                  <p className="text-sm text-muted-foreground">
                    Visualização de acurácia geral, F1-Score e IoU (Intersection over Union)
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent>
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>Planejamento urbano e análise de expansão de cidades</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-geo-green font-bold mt-1">•</span>
                  <span>Monitoramento de mudanças no uso do solo e desmatamento</span>
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-geo-green font-bold mt-1">•</span>
                  <span>Análise de impacto ambiental e estudos de viabilidade</span>
                </li>
              </ul>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    <li>Modelo de ML customizado</li>
                    <li>API REST</li>
